 ...
 *
 * <p>
 * Given the following exception and message bundle interface method the {@code InvalidIntValueException(final
 * RuntimeException cause, final String msg, final int value)}
