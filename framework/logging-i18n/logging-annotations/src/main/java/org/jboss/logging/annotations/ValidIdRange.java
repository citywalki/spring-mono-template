...
/**
 * Sets a range of valid id's allowed on the {@link Message#id() message id}. Both {@link
...
public @interface ValidIdRange {
    ...
    /**
     * The minimum id allowed in the {@link Message#id() message id}. Both {@link
     * Message#INHERIT} and {@link Message#NONE} are ignored when validating.
     *
    ...
    /**
     * The maximum id allowed in the {@link Message#id() message id}. Both {@link
     * Message#INHERIT} and {@link Message#NONE} are ignored when validating.
     *
