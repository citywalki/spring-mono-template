...
/**
 * A factory to create a {@link com.mycim.logging.processor.model.MessageInterface} for annotation processors.
 *
...
public final class MessageInterfaceFactory {
    ...
    /**
     * Creates a message interface from the {@link TypeElement} specified by the {@code
    ...
    private static Collection<ExecutableElement> getMessageMethods(final TypeElement intf) {
        return ElementFilter
                .methodsIn(intf.getEnclosedElements())
                .stream()
    ...
    private static class AptMessageInterface extends AbstractClassType implements MessageInterface {
        ...
        private AptMessageInterface(final TypeElement interfaceElement, final ProcessingEnvironment processingEnv,
            ...
            if (addGeneratedAnnotation) {
                ...
                if (generatedAnnotation == null) {
                    ...
                    generatedAnnotation = processingEnv
                            .getElementUtils()
        ...
        private void init() {
            final MessageMethodBuilder builder = MessageMethodBuilder
                    .create(processingEnv, expressionProperties)
            ...
            // Get the FQCN
            final TypeElement loggingClass = ElementHelper.getClassAnnotationValue(interfaceElement,
                                                                                   MessageLogger.class, "loggingClass");
    ...
    private static class LoggerInterface extends AbstractClassType implements MessageInterface {
        ...
        static LoggerInterface of(final ProcessingEnvironment processingEnv) {
            final LoggerInterface result = new LoggerInterface(processingEnv, ElementHelper.toTypeElement(processingEnv,
                                                                                                          BasicLogger.class));
            result.init();
            return result;
        }
