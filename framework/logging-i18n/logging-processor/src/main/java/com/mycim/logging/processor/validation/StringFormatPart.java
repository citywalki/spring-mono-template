...
class StringFormatPart extends AbstractFormatPart {
     ...
     * @throws DuplicateFormatFlagsException if the flag is specified more than once.
     */
    ...
    public enum Flag {
         ...
         * integrals and {@link org.jboss.logging.processor.validation.StringFormatPart.Conversion#SCIENTIFIC_NOTATION},
         * {@link org.jboss.logging.processor.validation.StringFormatPart.Conversion#DECIMAL} and
         * {@link org.jboss.logging.processor.validation.StringFormatPart.Conversion#SCIENTIFIC_NOTATION_OR_DECIMAL}
         * floating points.
         */
         ...
         * @throws UnknownFormatFlagsException if the flag is invalid.
         */
    ...
    public enum Conversion {
         ...
         * @throws UnknownFormatConversionException if the character is not a valid conversion format.
         */
