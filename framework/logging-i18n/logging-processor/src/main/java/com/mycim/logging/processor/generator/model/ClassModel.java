...
public abstract class ClassModel {
     ...
     */
    ClassModel(final ProcessingEnvironment processingEnv, final MessageInterface messageInterface,
    ...
    JClassDef generateModel() throws IllegalStateException {
        ...
        classDef._extends(className + "i18n");
    ...
    JMethodDef addMessageMethod(final MessageMethod messageMethod, final String messageValue) {
        ...
        if (method == null) {
            ...
            if (field == null) {
                ...
                field = classDef.field(JMod.PRIVATE | JMod.STATIC | JMod.FINAL, String.class, methodName,
                                       JExprs.str(msg));
    ...
    protected JMethodDef createReadResolveMethod() {
        ...
        final JVarDeclaration instance = classDef.field(JMod.PUBLIC | JMod.STATIC | JMod.FINAL, type,
                                                        INSTANCE_FIELD_NAME, type._new());
    ...
    JCall createLocaleGetter(final String locale, final boolean override) {
        ...
        final JVarDeclaration defaultInstance = classDef.field(JMod.PRIVATE | JMod.STATIC | JMod.FINAL, localeType,
                                                               "LOCALE", determineLocale(locale, localeType));
