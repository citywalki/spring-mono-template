...
final class ParameterFactory {
    ...
    public static Set<Parameter> of(final ProcessingEnvironment processingEnv, final ExecutableElement method) {
        ...
        for (VariableElement param : params) {
            ...
            if (method.isVarArgs()) {
                result.add(
                        new AptParameter(processingEnv, qualifiedType, param, formatClass, (++index == params.size())));
            } else {
    ...
    private static class AptParameter extends AbstractClassType implements Parameter {
        ...
        AptParameter(final ProcessingEnvironment processingEnv, final String qualifiedType, final VariableElement param,
            ...
            isFormatArg =
                    param.getAnnotationMirrors().isEmpty() || ElementHelper.isAnnotatedWith(param, FormatWith.class) ||
        ...
        @Override
        public int hashCode() {
            return HashCodeBuilder.builder().add(qualifiedType).add(param).toHashCode();
        }
        ...
        public String toString() {
            return ToStringBuilder.of(this).add("name", name()).add("type", asType()).toString();
        }
