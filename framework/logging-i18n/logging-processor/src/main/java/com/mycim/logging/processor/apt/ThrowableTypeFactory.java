...
import com.mycim.logging.processor.util.Objects;
...
import static com.mycim.logging.processor.util.Objects.HashCodeBuilder;
import static com.mycim.logging.processor.util.Objects.areEqual;
...
final class ThrowableTypeFactory {
    ...
    private static class AptThrowableType extends AbstractClassType implements ThrowableType {
        ...
        protected void init() {
            if (!type.getKind().isPrimitive() && type.getKind() != TypeKind.VOID) {
                ...
                final List<ExecutableElement> constructors = ElementFilter.constructorsIn(
        ...
        public String toString() {
            return Objects.ToStringBuilder
                    ...
                    .add("throwableAndStringConstructor", throwableAndStringConstructor)
                    .toString();
        }
    ...
    private static class AptReturnThrowableType extends AptThrowableType {
        ...
        protected void init() {
            ...
            if (signature != null) {
                final List<TypeMirror> args = ElementHelper.getClassArrayAnnotationValue(method, Signature.class,
                                                                                         "value");
        ...
        protected void init(final List<? extends VariableElement> params) {
            ...
            if (neededParamSize == params.size()) {
                // Checks for the first constructor that can be used. The compiler will end-up determining the
                // constructor
