...
import com.mycim.logging.processor.model.ReturnType;
import com.mycim.logging.processor.model.ThrowableType;
import com.mycim.logging.processor.util.Comparison;
import com.mycim.logging.processor.util.ElementHelper;
import com.mycim.logging.processor.util.Expressions;
...
import static com.mycim.logging.processor.util.ElementHelper.isAnnotatedWith;
import static com.mycim.logging.processor.util.Objects.*;
...
final class MessageMethodBuilder {
    ...
    static MessageMethodBuilder create(final ProcessingEnvironment processingEnv,
                                       final Properties expressionProperties) {
    ...
    Set<MessageMethod> build() {
        ...
        for (ExecutableElement elementMethod : methods) {
            ...
            if (resultMethod.isOverloaded()) {
                resultMethod.messageMethodName =
                        resultMethod.name() + resultMethod.formatParameterCount() + MESSAGE_METHOD_SUFFIX;
    ...
    private MessageMethod.Message findMessage(final Collection<ExecutableElement> methods,
    ...
    /**
     * Checks to see if the method has or inherits a {@link Message}
     * annotation.
     *
     ...
     * format parameters only. Parameters annotated with {@link Cause} or
     * {@link Param}
     * are not counted.
     *
     * @param methods the method to search.
    ...
    /**
     * Returns the number of parameters excluding the {@link Cause} parameter
     * and any {@link Param} parameters if found.
     *
    ...
    private static class AptMessageMethod implements MessageMethod {
        ...
        public Set<Parameter> parametersAnnotatedWith(final Class<? extends Annotation> annotation) {
            ...
            return parameters.containsKey(type.asType()) ? Collections.unmodifiableSet(
                    parameters.get(type.asType())) : Collections.emptySet();
        }
        ...
        @Override
        public int hashCode() {
            return HashCodeBuilder.builder().add(name()).add(parameters()).add(returnType()).toHashCode();
        }
        ...
        public boolean equals(final Object obj) {
            ...
            return areEqual(name(), other.name()) && areEqual(parameters, parameters) &&
